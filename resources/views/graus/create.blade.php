...
@section('content')
    ...
    <form class="ui form" id='grau_form' action="{{route('grau.store')}}" method="POST">
        @csrf
            ...
            <div class="three fields">
                    <div class="field">
                            ...
                            <div class="ui  labeled input">
                                ...
                                <input type="text" name="grau"value="{{ @old('grau') }}" id="grau" placeholder="Grau académico" autocomplete="off" required>
