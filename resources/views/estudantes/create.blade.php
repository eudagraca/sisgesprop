        ...
        <form class="ui form">
                ...
                <div class="two fields">
                    ...
                    <div class="required field">
                        ...
                        <select name="nacionalidade" class="ui dropdown">
                            <option value="" disabled="disabled" selected="selected">Seleccione a nacionalidade | Select
                                a
                                nationality</option>
            ...
            <div class="three fields">
                ...
                <div class="field">
                    ...
                    <input type="text" name="naturalidade" maxlength="3"
            ...
            <div class="one ui buttons float-right field">
                <button class="ui right labeled green icon button next1">Próximo<i class="chevron right icon"></i></button>
            </div>
    ...
    <div id="contacts">
        <form class="ui form">
            ...
            <div class="three fields">
                ...
                <div class="required field">
                    ...
                    <select name="morada_pais" class="ui dropdown">
                        <option value="" disabled="disabled" selected="selected">Seleccione o país | Select country
                        </option>
            ...
            <div class="float-right field">
                <button class="ui left labeled yellow icon button prev1"><i class="chevron left icon"></i>Anterior</button>
                <button class="ui right labeled green icon button next2">Próximo<i class="chevron right icon"></i></button>
            </div>
        </form>
    </div>
        ...
        <form class="ui form">
            <div class="field">
                ...
                <div class="three fields">
                    <div class="required field">
                        ...
                        <div class="ui calendar">
                            <div class="ui input left icon">
                                ...
                                <input type="text" id="select_date" name="data_conclusao"
                    ...
                    <div class="required field">
                        <label for="localidade_morada">Localidade | Place</label>
                        <input type="text" name="localidade_morada"
            ...
            <div class="float-right field" style="margin-bottom: 1%;">
                ...
                <button  class="ui right labeled green icon button submit"><i class="save icon"></i> Registar estudante</button>
            </div>
