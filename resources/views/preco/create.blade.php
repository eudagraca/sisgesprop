            ...
            <div class="three fields">
                    <div class="field">
                            ...
                            <div class="ui right labeled input">
                                ...
                                <input type="text" name="preco_matricula" id="preco_matricula" placeholder="Preço de matricula" autocomplete="off" required>
                    ...
                    <div class="field">
                            ...
                            <div class="ui right labeled input">
                                <label for="amount" class="ui label">MZN</label>
                                <input type="text" name="preco_inscricao" id="preco_inscricao" placeholder="Preço de inscrição" autocomplete="off" required>
