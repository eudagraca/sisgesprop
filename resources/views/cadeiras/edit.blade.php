...
<form class="ui form" action="{{route('cadeiras.update', $cadeira->id)}}" method="POST">
        ...
        <div class="field">
            ...
            <div class="three fields">
                ...
                <input type="text" name="nome" id="nome" value="{{$cadeira->nome}}" placeholder="Nome da cadeira" autocomplete="off" required>
                </div>
                <div class="field">
                    <label for="codigo">Codigo da cadeira</label>
                    <input type="text" name="codigo" id="codigo" value="{{$cadeira->codigo}}" placeholder="Codigo da cadeira" autocomplete="off"
                        required>
                </div>
                <div class="field">
