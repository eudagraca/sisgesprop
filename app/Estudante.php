...
class Estudante extends Model
{
    ...
    protected $fillable = [
        ...
        'naturalidade','sexo','estado_civil','ocupacao','morada', 'morada_localidade','morada_pais','codigo_postal','qualificacao_previa','instituicao_ensino_medio','data_conclusao','localidade_morada_educacao','pais_estudo', 'curso_id', 'grau_id'
    ];
    //timestamp
